...
# Momentos
# sigma_m <- sqrt(log(var(datos$Payment)/mean(datos$Payment)^2 + 1))
```
...
Luego de hacer los respectivos cálculos numéricos, se puede probar que dicha integral converge a `r format(es_def, scientific = F)`
